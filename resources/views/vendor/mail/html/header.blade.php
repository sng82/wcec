...
<img src="data:image/png;base64,{{ base64_encode(file_get_contents(Vite::asset('resources/img/wcec-crest-updated.png'))) }}" alt="WC-EC Crest" style="height: 100px; width: 63px;">
