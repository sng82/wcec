...
<img src="data:image/png;base64,{{ base64_encode(file_get_contents(Vite::asset('resources/img/wcec-crest-small-2.png'))) }}" alt="WC-EC Crest" style="height: 100px; width: 63px;">
