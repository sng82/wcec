<div class="bg-gradient-to-r from-sky-500 to-teal-500 px-6 py-4 lg:mx-6 rounded-lg flex flex-row items-center justify-center text-white gap-6 shadow-md shadow-slate-400">
