...
<div {{ $attributes->class(['bg-slate-100 rounded-lg p-3 xl:p-4 shadow']) }}>
    ...
    <hr class="my-4">
    <p class="mb-2">
        Your registration expires <span class="font-bold">{{ \Carbon\Carbon::parse($logged_in_user->registration_expires_at)->toFormattedDayDateString() }}</span>.
    </p>
{{--    @if( $logged_in_user->)--}}
{{--    @endif--}}
    <p>You should submit your CPD (Continual Professional Development) and pay your renewal fee before this date to remain registered.</p>
