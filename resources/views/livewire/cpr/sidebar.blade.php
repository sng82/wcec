    ...
    <div class=" w-full flex sticky-top space-y-2 flex-col">
        ...
        <div class="flex flex-col h-full justify-between">
            <div class="flex flex-col ">
                ...
                <div class="flex flex-col content-center w-full h-16 px-3">
                    <button
                        @click="sidebar_open = !sidebar_open"
                        class="flex content-center py-2 mt-4 font-semibold transition-all ease-in-out duration-500 text-white hover:text-cyan-400"
                    >
