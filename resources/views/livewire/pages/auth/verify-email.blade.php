...
<div>
    ...
    <div class="mt-4 flex items-center justify-between">
        ...
        <button wire:click="logout" type="submit" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
            {{ __('Log Out') }}
        </button>
    </div>
</div>
