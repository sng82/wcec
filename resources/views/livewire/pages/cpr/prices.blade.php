<div class="flex h-full w-full overflow-hidden">
    ...
    <div class="right w-full flex grow flex-col p-6 gap-5 overflow-y-auto">
...
{{--        @dump($upcoming_prices->count())--}}
        ...
        <div class="bg-white rounded-lg p-6 shadow">
                ...
                <form wire:submit="create">
                    <div class="flex flex-col xl:flex-row">
                        <div class="mt-4">
                            ...
                            <select wire:model="price_type" name="price_type" id="price_type" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        ...
                        <div class="mt-4 xl:ms-3">
                            ...
                            <div class="flex flex-row">
                                ...
                                <input wire:model="amount" type="number" name="amount" id="amount" placeholder="00.00" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" min="0" step="any" required>
                            </div>
            ...
            <ul class="list-disc ml-5">
                ...
                <li>When a new prices is added, an end date will be added to the current (outgoing) price automatically.</li>
                <li>If a new price of the type you're adding is already scheduled, adding another one here will replace it.</li>
            </ul>
        </div>
