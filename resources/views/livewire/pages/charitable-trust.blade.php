        ...
        <div class="container mx-auto px-5">
            <div class="flex flex-col gap-8 xl:gap-x-12 xl:flex-row 2xl:gap-16">
                ...
                <div class="grow text-sky-950">
                    ...
                    <p>
                        The Trust was established as a charity by trust deed 29 September 1976 under the name of the Worshipful Company of Environmental Cleaners Benevolent Fund. It is registered with the Charity Commissioners as No 271058.
                    </p>
                    <p>
...
{{--                        <li>Benefit other charitable institutions (where more than one of the Trustees sees fit and with the consent of the company).</li>--}}
                    ...
                    <hr class="mb-2">
                    <p>
                        Members are expected to support the Trust by way of voluntary annual donations supported by <a href="https://www.gov.uk/donating-to-charity/gift-aid" target="_blank" class="text-red-600 hover:text-red-700">Gift Aid</a>.
                        The benefit to the Company of a Gift Aid donation is that tax at the basic rate is recoverable from the Inland Revenue. The benefit to the individual, if you are a higher rate taxpayer, is that you can offset the gross amount of the voluntary donation against income tax.
                    </p>
                    <p>
                        In addition, members are encouraged to sign up to and use <a href="https://www.giveasyoulive.com/" target="_blank" class="text-red-600 hover:text-red-700">Give as you Live</a>.

                        Give as you Live is a shopping and price comparison website with a heart. You can shop for products from thousands of leading online retailers; use the price comparison tool to ensure you get the best price and even save money by using the exclusive offers and deals available on the site.
                    </p>
                    <p>
