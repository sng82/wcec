                ...
                <div class="container mx-auto px-5">
                    ...
                    <div class="flex flex-col gap-8 xl:gap-x-12 xl:flex-row 2xl:gap-16">
                        ...
                        <div class="">
                            ...
                            <h2 class="mt-12 mb-2 text-2xl xl:text-3xl ">Becoming a Livery Company</h2>
                            <hr class="mb-2">
                            <p>
                            ...
                            <ul class="my-6 ml-4 list-disc marker:text-red-700 space-y-4">
                                <li>
    ...
    <div class="w-full py-12 lg:py-20 bg-slate-100">
        <div class=" text-sky-950 px-5">
            <div class="container mx-auto px-5">
                ...
                <h2 class="mb-2 text-2xl xl:text-3xl ">The Founder and Founding Members</h2>
                <hr class="mb-4">
                <h3 class="text-xl xl:text-2xl mb-2">
                ...
                <h3 class="mt-8 mb-2 text-xl xl:text-2xl">Founding Members</h3>
                <hr class="mb-2">
                <ul class="mb-6 ml-4 list-disc marker:text-red-700 space-y-1 md:columns-2 xl:columns-3">
                    <li>Gordon Davies *# (First Master of the Guild)</li>
                    <li>Donald Pearse * (1st First Senior Warden of the Guild)</li>
                    <li>David Williams *# (1st Junior Warden of the Guild)</li>
                    <li>Lord Ashcroft</li>
                    <li>Anthony O’Connor #</li>
                    <li>John Ayres *#</li>
                    <li>James Pendle #</li>
                    <li>Ronald Ayres</li>
                    <li>George Perkins #</li>
                    <li>Brain Barclay *#</li>
                    <li>Peter Pritchard</li>
                    <li>Alan Berry</li>
                    <li>Harold Russell #</li>
                    <li>George Clayton #</li>
                    <li>Maurice Ryer</li>
                    <li>Henry Courtney</li>
                    <li>Mark Silver</li>
                    <li>Milton Davis</li>
                    <li>Mervyn Silver</li>
                    <li>Patrick Doyle #</li>
                    <li>Paul Silver</li>
                    <li>Edward Evans</li>
                    <li>Dr Brian Smith *</li>
                    <li>John Fraser #</li>
                    <li>David Smith #</li>
                    <li>Sidney Gordon</li>
                    <li>Phillip Turner #</li>
                    <li>Robert Goymour</li>
                    <li>Theo van der Pasch #</li>
                    <li>Eric Green *</li>
                    <li>Alan Vause *</li>
                    <li>Reginald Hall</li>
                    <li>Gordon Warren</li>
                    ...
                    <li>Donald Wells *</li>
                    <li>Leslie James</li>
                    <li>Harold Whiting *</li>
                    <li>Eric Laker #</li>
                    <li>Stanley Wilby</li>
                    <li>Lt. Col. Ian Little *#</li>
                    <li>Robert Wilson</li>
                    <li>John Morris</li>
                </ul>
                <p class="mb-0">
                    <span class="inline-block w-4">*</span> Past Masters<br>
                    <span class="inline-block w-4">#</span> Deceased
                </p>
