    ...
    <div class="w-full bg-white py-12 lg:py-20">
        <div class="container mx-auto px-5">
            <div class="bg-white text-sky-950">
                ...
                <p>
                    If you are interested in finding out more about joining the Environmental Cleaners, please drop us a line.
                </p>
                        ...
                        @else
                            <div class="rounded border border-slate-200 p-5 mt-4 bg-slate-100 xl:w-full">
                                <form wire:submit="submit" class="w-full">
                                    ...
                                    <input type="text" wire:model="name" class="form-input min-w-[400px] rounded border @error('email') border-red-600 @else border-slate-200 @enderror block w-full" name="name" id="name" />
                                    <div>
                                    ...
                                    <input type="email" wire:model="email" class="form-input rounded border @error('email') border-red-600 @else border-slate-200 @enderror block w-full" name="email" id="email" />
                                    <div>
                                    ...
                                    <input type="number" wire:model="phone" class="form-input rounded border @error('email') border-red-600 @else border-slate-200 @enderror block w-full" name="phone" id="phone" />
                                    <div>
                                    ...
                                    <textarea wire:model="message" class="form-input rounded border @error('email') border-red-600 @else border-slate-200 @enderror block w-full" name="message" id="message" rows="3"></textarea>
                                    <div>
